...
`,[_(L("&","--n-merged-color: var(--n-color-modal);")),K(L("&","--n-merged-color: var(--n-color-popover);")),L("img",`
 width: 100%;
 height: 100%;
 `),H("text",`
 white-space: nowrap;
