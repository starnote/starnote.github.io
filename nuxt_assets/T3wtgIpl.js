import{G as E,a as L,k,l as V,d as j,h as y,aJ as H,aK as O,R as S,u as A,z as x,f as K,D as M,aL as v,ai as T,aj as $,at as D,ak as s,al as F,ao as i,aM as G}from"./DmSE3pc0.js";let w=!1;function I(){if(E&&window.CSS&&!w&&(w=!0,"registerProperty"in window?.CSS))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function J(e){const{heightSmall:n,heightMedium:a,heightLarge:t,borderRadius:r}=e;return{color:"#eee",colorEnd:"#ddd",borderRadius:r,heightSmall:n,heightMedium:a,heightLarge:t}}const W={common:L,self:J},q=k([V("skeleton",`
 height: 1em;
 width: 100%;
 transition:
